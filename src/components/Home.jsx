...
import image1 from "./assets/laravel.png";
import image2 from "./assets/download html.png";
import image3 from "./assets/download python.png";
export default function Home() {
  return (
    <>
      ...
      <h1 class="display-2 d-flex justify-content-center p-8">QUESTION/ANSWER</h1>
